    ...
    if '_v2' in each:
        ...
        for b in os.listdir(folder + each):
            ...
            if '.txt' not in b and '_figs' not in b:
                ...
                de_branch_fdr = de2['pvalue'].tolist()
...
dreamit_file.to_csv('/projects/sysbio/users/nathanmaulding/results/dreamit_fdr_results3.csv')
de_file = pd.DataFrame(final_de)
de_file.to_csv('/projects/sysbio/users/nathanmaulding/results/de_fdr_results3.csv')
