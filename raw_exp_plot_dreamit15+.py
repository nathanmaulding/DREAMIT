...
#path = '/Users/nathandmaulding/Desktop/Smoothing test/ebi10/test_binopt2_ebi10_raw.txt' # or use json
path2json = '/Users/nathandmaulding/Desktop/DREAMIT2/Data/EBI-4-Induced dendritic/EBI4_E-HCAD-13.json'
path2 = '/Users/nathandmaulding/Desktop/v20Data/EBI4/4_2_Smoothed_Expression_dictionary.txt'
branch = '4 -> 2'
b = '_4_2'
gene_list2 = ['CEBPB', 'HDAC1', 'EZH2', 'CTNNB1']
dataset = 'EBI4'
var = 'psuedotime'
#exp = openFile(path, 2)
...
for gene in gene_list:
    ...
    xy = np.vstack([rawptime, np.log(generaw)])
    ...
    ax_joint.scatter(rawptime, np.log(generaw), c=z, s=8)
    ax_joint.plot(smoothexp['psuedotime_med'].tolist(), np.log(smoothexp[gene].tolist()), color='black', linewidth=2, alpha=0.65)
    ax_joint.scatter(smoothexp['psuedotime_med'].tolist(), np.log(smoothexp[gene].tolist()), color='black', s=25)
    ...
    #######################################################
    ax_marg_y.hist(np.log(generaw), orientation='horizontal', bins=20, color='gray')
    # Set labels on joint
    ax_joint.set_xlabel('Pseudotime')
    ax_joint.set_ylabel('Log(Expression)')
    ...
    ax_marg_y.set_xlabel('Log(Expression)')
    ax_marg_x.set_ylabel('Pseudotime')
